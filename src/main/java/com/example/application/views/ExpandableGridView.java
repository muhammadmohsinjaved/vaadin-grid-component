...
//
//@Route("expandable-grid-view")  // Defines the route // Matches the tag name of the LitElement component
//@JsModule("./expandable-grid.js")  // Correct path to the JavaScript file
